...
def ascDictToNumpyArray(dictionary):
...
def ascNumpyArrayToDict(numpyArray, keys):
    returnDict = dict()
    for i in range(0, len(numpyArray)):
        returnDict[keys[i]] = numpyArray[i]
    return returnDict
...
#     plt.plot(xx, yy, label=dataset_name +", Lambda: " + str(experiment2345.lambda_error) + ", Remaining features: " + str(parameters.removing_percentage))
#     plt.legend(loc="upper right")
#     plt.xlabel("Proportion Train")
#     plt.ylabel("Test Error Rate %")
#     plt.grid()
#     plt.savefig('./figures/' + dataset_name +'_' + str(1-parameters.removing_percentage) +'_' + str(experiment2345.lambda_error) + '_' + time.strftime("%Y%m%d-%TKDE_R1_H%M%S") + '.png')
#     plt.show()
#     plt.clf()
...
#     plt.grid()
#     plt.savefig('./figures/'+dataset_name+time.strftime("%Y%m%d-%TKDE_R1_H%M%S")+'features.png')
#     plt.show()
#     plt.clf()
...
#     plt.plot(xx, yy, label=dataset_name+", B: "+str(parameters.sparsity_B)+", Lambda(sparsity): "+str(experiment2345.sparsity_regularizer))
#     plt.legend(loc="upper right")
#     plt.xlabel("Classifiers")
#     plt.ylabel("Dimension")
#     plt.grid()
#     plt.savefig('./figures/' + dataset_name +'_' + str(1-parameters.removing_percentage) +'_' + str(experiment2345.lambda_error) + '_' + time.strftime("%Y%m%d-%TKDE_R1_H%M%S") + 'sparsity.png')
#     plt.show()
#     plt.clf()
#
